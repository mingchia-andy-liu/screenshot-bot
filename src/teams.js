...
exports.getTeamById = (id) => teams.find((t) => t.teamId === id);
exports.getTeamBytricode = (code) => teams.find((t) => t.tricode === code);
exports.getTeamByNickName = (name) => teams.find((t) => t.nickname === name);
exports.getTeamByUrlName = (name) => teams.find((t) => t.urlName === name);
exports.getTeamByFullName = (name) => teams.filter((t) => t.fullName === name);
exports.getNBATeams = () => teams.filter((t) => t.isNBAFranchise);
exports.getEastTeams = () => getNBATeams().filter((t) => t.confName === 'East');
exports.getWestTeams = () => getNBATeams().filter((t) => t.confName === 'West');
